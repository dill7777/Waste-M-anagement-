      ...
      floatingActionButton: Consumer<Mainprovider>(
        builder: (context,value,child) {
          return FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>AddService(from: 'NEW', oldid: "")));
            },
              ...
              builder: (context,value,child) {
                return
                  ...
                  itemBuilder: (context, index) {
                    print("ahbdhsd"+value.servicelist.length.toString());
                    return InkWell(
                      onTap: () {
                        showDialog(
                          context: context,
                              ...
                              Center(
                                child: Row(
                                  children: [
                                    TextButton(
                                      onPressed: () {
                                        value.DeleteServices(
                                            value.servicelist[index].id,context);
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        print("hjjk"+ value.servicelist[index].id);
                                        value.EditServices(
                                            value.servicelist[index].id);
                                        Navigator.pop(context);
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  AddService(
                                                      from: "EDIT",
                                                      oldid: value.servicelist[index].id
                                                  ),
                                            ));
                                      },
                                      child:Container(
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(value.servicelist[index].Photo),fit: BoxFit.fill
                                ),
                          ...
                          Text(value.servicelist[index].Name,style: TextStyle(
                              fontSize: 14,
                              fontFamily: "kadwa"
                          ),)
                        ],
